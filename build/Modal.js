...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _ModalSoy = __webpack_require__(60);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	goog.loadModule(function (exports) {
	  ...
	  function $render(opt_data, opt_ignored, opt_ijData) {
	    ...
	    ie_open('div', null, null, 'class', 'modal-dialog');
	    ie_open('div', null, null, 'class', 'modal-content');
	    ie_open('header', null, null, 'class', 'modal-header');
	    ie_open('button', null, null, 'type', 'button', 'class', 'close', 'data-onclick', 'hide');
	    ie_open('span');
	    itext('\xD7');
	    ie_close('span');
	    ie_close('button');
	    ...
	    if (opt_data.footerButtons) {
	      ...
	      for (var buttonIndex15 = 0; buttonIndex15 < buttonListLen15; buttonIndex15++) {
	        ...
	        ie_open('button', null, null, 'type', 'button', 'class', ($$temp = buttonData15['class']) == null ? '' : $$temp);
